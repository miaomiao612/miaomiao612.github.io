...
<div style="display: flex; justify-content: space-between; align-items: flex-start;">
  ...
  <div style="display: flex; flex-direction: column; align-items: center; margin-right: 10px; max-width: 50%; width: 100%;">
    ...
    <a href="https://drive.google.com/file/d/1W03U_qFdNaPNj8fo57FOA7paRPP3td1s/view?usp=drive_link" style="font-size: 17px; text-decoration: none; text-align: center;">Enhancing Urban Planning Through generative AI-Driven Street view Modifications </a>
  </div>
